...
<!-- Mirrored from st.ourhtmldemo.com/template/organic_store/blog-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Jul 2020 10:09:55 GMT -->
<head>
		<meta charset="UTF-8">
		<!-- For IE -->
	...
	<body>
					...
					<div id="isotop_wrapper">
						<div class="col-md-4 col-sm-6 col-xs-12 isotop_item">
							<div class="blogList_single_post clear_fix wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
								...
								<div class="post">
									<div class="text">
										<h4><a href="blog-details.html">5 things in your daily meals.</a></h4>
										<ul>
		...
		<!-- Vendor js _________ -->
		<!-- Google map js -->
		<script src="{{ asset('https://maps.googleapis.com/maps/api/js?key=AIzaSyCRvBPo3-t31YFk588DpMYS6EqKf-oGBSI')}}"></script> <!-- Gmap Helper -->
...
<!-- Mirrored from st.ourhtmldemo.com/template/organic_store/blog-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Jul 2020 10:10:03 GMT -->
</html>